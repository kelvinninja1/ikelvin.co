...
public static function rp_sendsms($source,$destination,$data,$type){
    $username = "ikelvin";
	$password = "kerrison41@";
	...
	echo '
<form id="my_form" action="https://api.nalosolutions.com/bulksms/" method="GET" target="hidden-form">
    <input type="hidden" name="username" value="'.htmlspecialchars($username) .'">
    <input type="hidden" name="source" value="'.htmlspecialchars($source) .'">
    <input type="hidden" name="destination" value="'.htmlspecialchars($destination) .'">
    <input type="hidden" name="type" value="'.htmlspecialchars($type) .'">
    <input type="hidden" name="message" value="'.urldecode($data).'">
